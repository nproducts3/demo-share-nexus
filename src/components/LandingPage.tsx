...
export const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      <header className="border-b-2 border-blue-400/30 bg-black/40 backdrop-blur-xl sticky top-0 z-50 shadow-2xl">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-400 rounded-xl flex items-center justify-center shadow-2xl">
            ...
            <div className="flex items-center space-x-3">
              <Button 
                ...
                className="hidden sm:inline-flex border-2 border-blue-400/50 bg-blue-500/20 text-white hover:bg-blue-500/30 hover:border-blue-300 transition-all duration-200 shadow-xl font-semibold px-6 py-3 h-12"
              >
                Sign In
              </Button>
              <Button 
                onClick={onLoginClick} 
                className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white shadow-2xl hover:shadow-3xl transition-all duration-200 font-bold px-8 py-3 h-12 border-2 border-blue-400/30 hover:border-blue-300/50"
              >
                Get Started
              </Button>
            </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-5xl mx-auto">
            <h1 className="text-5xl lg:text-7xl font-bold bg-gradient-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent leading-tight mb-6">
              Transform Your Demo Experience
            </h1>
            <p className="text-xl text-blue-100/90 leading-relaxed max-w-4xl mx-auto mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                size="lg" 
                onClick={onLoginClick}
                className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white text-xl px-12 py-4 h-16 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-200 font-bold border-2 border-blue-400/30 hover:border-blue-300/50"
              >
              ...
              <Button 
                ...
                disabled
                className="w-full sm:w-auto text-xl px-12 py-4 h-16 border-2 border-white/20 text-white/40 cursor-not-allowed opacity-40 bg-white/5"
              >
      ...
      <section className="py-16 bg-black/50 backdrop-blur-sm px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100/90 max-w-4xl mx-auto">
            ...
            {features.map((feature, index) => (
              <Card key={index} className="border-2 border-blue-400/30 bg-white/10 backdrop-blur-sm hover:bg-white/15 transition-all duration-300 group h-full shadow-xl hover:shadow-2xl">
                <CardHeader className="pb-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-400/30 to-indigo-400/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg">
                    <feature.icon className="h-6 w-6 text-blue-300" />
                  </div>
                  <CardTitle className="text-xl text-white mt-3">{feature.title}</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-blue-100/80 leading-relaxed">
                    {feature.description}
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card key={index} className={`relative border-2 transition-all duration-300 hover:shadow-2xl h-full backdrop-blur-sm ${
                ...
                {plan.highlighted && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-2 rounded-full font-bold shadow-xl">
                      Most Popular
                    </span>
                  </div>
                )}
                <CardHeader className="text-center pb-3">
                  ...
                  <div className="flex items-baseline justify-center mt-3">
                    ...
                    <span className="text-blue-200 ml-2 text-lg">{plan.period}</span>
                  </div>
                  <CardDescription className="mt-3 text-blue-100/80 text-base">{plan.description}</CardDescription>
                </CardHeader>
                <CardContent className="space-y-3 flex-1 flex flex-col">
                  ...
                  <Button 
                    className={`w-full mt-4 shadow-xl hover:shadow-2xl transition-all duration-200 font-bold py-3 h-12 ${
                      plan.highlighted 
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600/80 to-indigo-600/80 backdrop-blur-sm px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Button 
            size="lg" 
            onClick={onLoginClick}
            className="w-full sm:w-auto bg-white text-blue-600 hover:bg-blue-50 text-xl px-12 py-4 h-16 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-200 font-bold"
          >
      ...
      {/* Enhanced Footer */}
      <footer className="bg-black/60 backdrop-blur-sm text-blue-100 py-8 px-6 border-t-2 border-blue-400/30">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center space-x-3">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-indigo-400 rounded-lg flex items-center justify-center shadow-xl">
